...
class CfgFunctions
{
	class Aux187_Droideka_Shields
	{
		class Shields
		{
			file="\187th-aux\Separatist_Assets\Sep_Turrets\Droideka"
...
class CfgVehicles
{
    ...
    {
        displayName = "187th Droideka Shield";
        ...
        class EventHandlers {
            init = "[_this] spawn Aux187_Droideka_Shields_fnc_init_DroidekaShield;";
        };
    };
	...
	class 187th_Droideka: k_CIS_Droideka
	{
		...
		typicalCargo[]={"O_UAV_AI"};
		class EventHandlers {
            init = "[_this] spawn Aux187_Droideka_Shields_fnc_initDroideka;";
        };
	};
};