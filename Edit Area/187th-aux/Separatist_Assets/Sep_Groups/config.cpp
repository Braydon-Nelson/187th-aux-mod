  ...
  class EAST
  {
    ...
    class 187th_Legion
    {
      ...
      class Infantry
      {
		...
		class 187THDroids_O_AA_Team
        {
          name="AA Team (3 droids)";
          faction="187THDroids_187th_Legion";
          side=0;
          class Unit0
          {
      ...
      class SpecOps
      {
        ...
        class 187THDroids_O_Commando_Melee_Team
        {
          ...
          {
            side=0;
            vehicle="187th_BX_Captain_Sword";
            rank="COLONEL";
            position[]={0,-0,0};
          };
          class Unit1
          {
            side=0;
            vehicle="187th_BX_Commando_Sword";
            rank="PRIVATE";
            position[]={0,-15,0};
          };
          class Unit2
