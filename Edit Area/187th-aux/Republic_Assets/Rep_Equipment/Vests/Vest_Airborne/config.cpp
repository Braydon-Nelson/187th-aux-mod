class CfgPatches
{
	class 187th_Airborne_Vests
	{
		...
		requiredAddons[] = {};
		units[] = {};
		weapons[] = {"187th_JLTS_CloneVestAirborne","187th_JLTS_CloneVestAirborneNCO","187th_JLTS_CloneVestAirborneSGT"};
	};
};
...
class CfgWeapons
{
	...
	class 187th_JLTS_CloneVestAirborneCPL: JLTS_CloneVestAirborneNCO
	{
	   displayName = "[187th] Airborne Clone Vest (CP)";
	...
	{
	   displayName = "[187th] Airborne Clone Vest (CS)";
	   model = "\MRC\JLTS\characters\CloneArmor\CloneVestAirborneNCO.p3d";
	   picture = "\MRC\JLTS\characters\CloneArmor\data\ui\CloneVestHeavy_ui_ca.paa";
	   hiddenSelections[] = {"camo1","camo2"};
	   hiddenSelectionsTextures[] = {"MRC\JLTS\characters\CloneArmor\data\Clone_vest_officer_co.paa","187th-aux\Data\Vests\Clone_vest_heavy_sgt.paa"};
	   class ItemInfo: VestItem
	   {
	      uniformModel = "\MRC\JLTS\characters\CloneArmor\CloneVestAirborneNCO.p3d";
		  vestType="Rebreather";
	...
	class 187th_JLTS_CloneVestAirborneCGS: JLTS_CloneVestAirborneNCO
	{
	   displayName = "[187th] Airborne Clone Vest (CGS)";
	   model = "\MRC\JLTS\characters\CloneArmor\CloneVestAirborneNCO.p3d";
	   picture = "\MRC\JLTS\characters\CloneArmor\data\ui\CloneVestHeavy_ui_ca.paa";
	   hiddenSelections[] = {"camo1","camo2"};
	   hiddenSelectionsTextures[] = {"MRC\JLTS\characters\CloneArmor\data\Clone_vest_officer_co.paa","187th-aux\Data\Vests\Clone_vest_heavy_gnrsgt.paa"};
	   class ItemInfo: VestItem
	   {
	      uniformModel = "\MRC\JLTS\characters\CloneArmor\CloneVestAirborneNCO.p3d";
		  vestType="Rebreather";
