class CfgPatches
{
	class 187th_Medic_Uniform
	{
		name = "187th Medic Uniform";
		author = "Panda";
		requiredVersion = 0.01;
		requiredAddons[] = {};
		units[] = {"187th_CloneArmor_Medic"};
		weapons[] = {"187th_Clone_Medic"};
	};
};
...
class CfgVehicles
{
	...
	class 187th_CloneArmor_Medic: 187_Base_Uniform
    {
        ...
        hiddenSelectionsTextures[] = {
            "\187th-aux\Data\Uniforms\Clone_187thMedic_armor.paa",
