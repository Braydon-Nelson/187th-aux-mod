class CfgPatches
{
	class 187th_LAAT_MK2_medical
	{
		name = "187th LAAT MK2 Medical";
		author = "PraetorPanda";
		requiredVersion = 0.01;
		requiredAddons[] = {};
		units[] = {"187th_LAAT_mk_2_medevac"};
		weapons[] = {};
	};
};
...
class CfgVehicles
{
	...
	class 187th_LAAT_mk_2_medevac : 3as_LAAT_Mk2
	{
		displayname="LAAT MK 2 (Medevac)";
		...
		{
			"\187th-aux\Data\Vehicles\Hull_Medical.paa",
			"\187th-aux\Data\Vehicles\Wings_Medical.paa",
