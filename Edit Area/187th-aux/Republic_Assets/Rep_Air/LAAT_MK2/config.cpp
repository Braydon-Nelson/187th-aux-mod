...
class CfgMagazines
{
	...
	class Aux187_LAAT_6Rnd_AGM_Missile : 3as_LAAT_8Rnd_Missile_AGM
	{
		displayName = "[187th] Torrent 6Rnd AGM Missiles";
		ammo = "3as_LAAT_AGM_Missile";
		count = 6;
	};
	
	class 3as_PylonMissile_LAAT_8Rnd_Missile_AA;
	class Aux187_LAAT_4Rnd_AA_Missile : 3as_PylonMissile_LAAT_8Rnd_Missile_AA
	{
		displayName = "[187th] Sidewinder 4Rnd AA Missiles";
		count = 4;
	};
};
